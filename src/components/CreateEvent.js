                            ...
                            <form onSubmit={this.storeNewEvent} method='POST'>
                                <div className='control-group'>
                                    <div className='form-group floating-label-form-group controls'>
                                        <label>Titulo</label>
                                        <input type='text' className='form-control' placeholder='Titulo' id='title' name='title' onChange={this.handleChange}></input>
                                    </div>
                                </div>
                                <div className='control-group'>
                                    <div className='form-group floating-label-form-group controls'>
                                        <label>Descripcion</label>
                                        <input type='text' className='form-control' placeholder='Detalles' id='description' name='description' onChange={this.handleChange}></input>
                                    </div>
                                </div>
